...
first, data are required to populate each \ac{KVS}. Second, workloads of concrete
...
strings. When the experiment starts, each individual \ac{KVS} is populated with these
key-value pairs.
