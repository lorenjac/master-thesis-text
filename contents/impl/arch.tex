...
overview, focus is set on NVRAM management, data structures, and serializable
MVCC.
...
The transaction table should provide fast lookup capabilities and is therefore
