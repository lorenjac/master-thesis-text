...
% of this thesis and is therefore not addressed further. Also, since volatile RAM
% continues to be available, there is no need to use NVRAM for sensitive data.
...
% systems incorporating NVRAM could face durable memory corruptions. NVRAM on the
...
% more often in NVRAM \cite{chen1996rio}. That said, stray writes are not
