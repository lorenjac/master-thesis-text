...
There are multiple ways to do build a memory hierarchy based on NVRAM \cite{bailey2011implications}. First, NVRAM may form an additional layer between traditional DRAM and conventional storage, thus serving as a durable storage cache \todo{has this been done?}. 
