...
plain software-based transactions in the field of databases and \ac{KVS}, in
particular.
...
properties. Notable examples are transactional memory for conventional \ac{RAM} and
