...
% * query-based (=> not suitable for ad-hoc queries)
% 	* fast range inclusion test during validation {neumann2015fast}
% 	* predict conflicts from query prior to execution
% 		* insert w/w conflicts {fekete2005making}
% 		* abort conflicting transaction {faleiro2015rethinking}
% * eliminate contention
% 	* parallel validation {bailey2013exploring, ding2015centiman, faleiro2015rethinking, wang2017efficiently}
% 	* decentralized ID/TS assignment and memory access {tu2013speedy, zhou2017posterior}
