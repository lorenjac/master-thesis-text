        ...
        \begin{itemize}
            \item optimize read-tracking or validation
                \begin{itemize}
                    ...
                    \item parallel validation \cite{bailey2013exploring, ding2015centiman, faleiro2015rethinking}
                    \item gather dependencies prior to execution (based on query language) \cite{faleiro2015rethinking}
                    \item eliminate points of contention (tid assignment, timestamps, shmem) \cite{tu2013speedy, zhou2017posterior}
                \end{itemize}
